...
Como forma de intervenção a esta complexidade, o Elasticsearch realiza buscas utilizando os benefícios herdado pela utilização do Lucene. Para disponibilização a consultas, é utilizado uma interface de comunicação REST que possibilita extração dos dados.
