...
Um dos maiores benefícios tragos através da utilização do Apach Lucene é a ação de indexação dos objetos e documentos. Utilizando disso, o Elasticsearch realiza busca, ordena, e filtra, persisti dos dados como objeto e documentos fornecidos realizando a indexação de todas suas ações. Consequentemente, esta tecnologia também é caracterizado como orientado a documento.
