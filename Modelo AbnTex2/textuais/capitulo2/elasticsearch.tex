...
Um dos maiores benefícios tragos através da utilização do Apach Lucene é a ação de indexação dos objetos e documentos. Utilizando disso, o Elasticsearch realização a persistência dos objeto fornecidos ou documentos???????. Consequentemente, esta tecnologia também é caracterizado como orientado a documento.
