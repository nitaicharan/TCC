...
Um dos maiores benefícios tragos através da utilização do Apach Lucene é a ação de indexação dos dados possibilitando a procura dos dados de forma mais rápida. Utilizando disso, o Elasticsearch realização a persistência dos objeto fornecidos ou documentos, e indexa posteriormente, para a localização de forma mais rápida. Consequentemente, esta tecnologia também é caracterizado como orientado a documento.
