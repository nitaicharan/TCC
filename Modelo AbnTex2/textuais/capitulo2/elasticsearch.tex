...
Como forma de intervenção a esta complexidade, o Elasticsearch foi criado para  ser capas de, utilizando os benefícios herdado pela utilização do Lucene, disponibiliza dados solicitados através de uma simples :uma API RESTful. Para disponibilização a consultas, é utilizado uma interface de comunicação REST que possibilita extração dos dados.
