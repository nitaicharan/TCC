...
Um dos maiores benefícios tragos através da utilização do Apach Lucene é a ação de indexação dos dados. Utilizando disso, o Elasticsearch realização a persistência dos dados e indexa seu conteúdo e documentos. Consequentemente, também é caracterizado como orientado a documento, pois transforma os conteúdo dos dados gravados em documentos
