...
can be challenging to use computer to extract relationships

useful fo a number of teasks including buiding knowledge bases, performing analysis of treds, gathering intelligence and performing product searches.
 
Finding relationships is called some time as Text Analytics
