Neste capítulo é descrito como a aplicação proposta para a intervenção ao problema anteriormente descrito abordagem a este problema através de uma aplicação a qual tem  se como objetivo facilitar o acesso a dados públicos de forma facilitada através de linguagem natural.
