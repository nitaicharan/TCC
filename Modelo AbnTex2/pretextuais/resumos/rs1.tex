Política de transparência públicas e fiscalização são essenciais para o controle do cidadão no controle e fiscalização de gastos públicos. Porém, tais cidadão certamente utilizaram como canal mediador entre entidade possuidora dos dados para fiscalização e o cidadão que atua como fiscal neste cenário. Excluindo assim, a participação de pessoas leigas na utilização e manipulação de elementos tecnológicos.
