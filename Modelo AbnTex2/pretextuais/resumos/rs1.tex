Política de transparência públicas e fiscalização são essenciais para o controle do cidadão no controle de gastos públicos. Porém, tais cidadão certamente utilizaram como canal mediador entre entidade possuidora dos dados para fiscalização e o cidadão que atua como fiscal neste cenário.
