Política de transparência públicas e fiscalização são essenciais para o controle do cidadão na política de gastos públicos. Para isso, é necessário que haja meios de divulgação destes dados e que seja de livre acesso aos cidadãos.
